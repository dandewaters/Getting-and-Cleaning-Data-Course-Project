...
Objective #5 -"From the data set in step 4, create a second, independent tidy data set with the average of each variable for each activity and each subject"
  I used group_by() to gather groups of each feature, variable, dimension, and activity, and then I used summarise() to apply the mean to all of the groups, resulting in the final tidy data means.
